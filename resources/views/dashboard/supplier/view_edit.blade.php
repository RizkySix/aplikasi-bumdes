...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div
        ...
        <h1 class="h2">Form Ubah Data Supplier</h1>
    </div>
</main>

<div class="row w-100 mt-4">
    <div class="col-md-9 ms-sm-auto col-lg-9 px-md-4">
        <form action="/suppliers/{{ $supplier->id }}" method="POST" class="needs-validation" novalidate>
            @method('put')
            @csrf
            <div class="row g-3">
                <div class="col-sm-10">
                    ...
                    <input type="text" name="nama_supplier"
                        class="form-control @error('nama_supplier') is-invalid @enderror" id="nama_supplier"
                        placeholder="" required value="{{ old('nama_supplier', $supplier->nama_supplier) }}">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="input-group has-validation">
                        ...
                        <input type="text" class="form-control  @error('pemilik') is-invalid @enderror" id="pemilik"
                            placeholder="" name="pemilik" value="{{ old('pemilik', $supplier->pemilik) }}" required>
                        @if (old('pemilik'))
                        @error('pemilik')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div class="col-sm-10">
                    ...
                    <input type="text" name="alamat" class="form-control @error('alamat') is-invalid @enderror"
                        id="alamat" placeholder="" required value="{{ old('alamat', $supplier->alamat) }}">
                    @if (old('alamat'))
                    @error('alamat')
                    <div class="invalid-feedback">
                        {{ $message }}
                ...
                <div class="col-sm-10">
                    ...
                    <input type="text" name="no_hp" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp"
                        placeholder="" required value="{{ old('no_hp', $supplier->no_hp) }}" minlength="8">
                    @if (old('no_hp'))
                    @error('no_hp')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <button class="col-md-2 btn btn-primary btn-md mt-4" type="submit">Ubah Data Supplier</button>
