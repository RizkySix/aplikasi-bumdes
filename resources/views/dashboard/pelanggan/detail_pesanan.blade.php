...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="text-center justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <p class="h5">Kode Pesanan : {{ $penjualan->kode_penjualan }}</p>
            ...
            <div class="col-sm-4" id="sats">
             ...
             @endphp
              ...
              <div class="col-sm-4">
                ...
                <span class="text-muted">{{ $penjualan->pembayaran }}</span>
              </div>
              ...
              <div class="col-sm-4">
               ...
               <span class="text-muted">{{ $penjualan->pengirim }}</span>
               @else
               <span class="text-muted">Pengirim Belum Diperbarui</span>
               @endif
                </div>
              <div class="col-sm-4">
