...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class=" justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-2 border-bottom">
      <h1 class="h2">Riwayat Penjualan Tahun {{ request('tahun') }}</h1>
      <div class="d-flex">
        <form action="/sesi_tahun/{{ request('tahun') }}" method="GET" style="margin-left:5px;">
  ...
  <div class="row-100">
    <div class="col-md-6 ms-sm-auto col-lg-10 px-md-4">
        <form action="/sesi_tahun/{{ request('tahun') }}" method="GET">
